...
<div class="container mainHomePageContainer mt-3 mb-5 pl-0 pr-0 pb-5" style="">
	<?php
	    ...
	    ?>
	<div class="card col-md-7 m-auto container upgradeSuccessCard pb-2" style="background: #FED8C6;">
		<div class="row">
			<div class="col-md-9 mt-5">
				<h5>Your Payment is Processed!</h5>
			...
			<div class="col-md-3 pt-4" style="">
				<img src="../assets/images-new/ticketPaymentConfirm.png" style="margin-left: -15%;margin-bottom: -10%;">
			</div>
		</div>
	</div>
</div>
